...
# docker run -v -p 8000:8000 -name jupyterhub -d -v path/to/jupyter-persistant:/jupyter-persistant jasonjwilliamsny/ubuntu-jhub-dev2.2
#
# Based on Ubuntu
...
CMD ["bash ./jupyter-persistant/createusers.sh"]
